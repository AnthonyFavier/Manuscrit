...
% \begin{center}
%     \textit{La simplicité réside dans l'art de rendre le complexe accessible,}

%     \textit{transformant ainsi la difficulté en facilité.}
% \end{center}

% \begin{center}

%     \textit{Simplifier rend les choses faciles et accessibles.}
    
%     \textit{Cependant, la simplicité réside dans la difficulté de l'épure.}

%     \textit{Il est alors vraiment facile de complexifier.}
