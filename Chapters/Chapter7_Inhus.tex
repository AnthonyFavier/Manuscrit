...
Simulating intelligent human avatars is a novel field and only few works apart from ours try to address this limitation. A similar work in ROS2 was recently presented in \cite{perezhunavsim}.
