...
Part~\ref{part:1} begins with Chapter~\ref{chap:2}, which presents the \acrshort{hatpehda} task planner. This planner has been the keystone of most of my work. Hence, the reader should understand the motivation and methods of this task planner.

Chapter~\ref{chap:3} describes my first main contribution, proposing models and algorithms to incorporate Theory of Mind concepts in \acrshort{hrc} task-planning. An empirical evaluation is provided and discussed, demonstrating how this contribution solves a broader class of problems than \acrshort{hatpehda} without systematic communication.
