...
\begin{itemize}
    \item navigation (plan+execution)
    \item motion (arm) to interact with environment
    ...
    \item perception (situation assessment, reasoning, estimation of human mental state and capabilities)
\end{itemize}
