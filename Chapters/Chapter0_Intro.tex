...
In this manuscript, robots are considered as autonomous tools able to interact physically with their environment. As tools, robots should facilitate human tasks by reducing both the required physical effort and mental workload. 
...
Chapter~\ref{chap:3} introduces my first main contribution using some Epistemic concepts in HRC task-planning. This contribution is focused on trying to better estimate human knowledge and making the robot proactive to inform humans about a relevant fact they are not aware of. Some models and algorithms are proposed and evaluated to integrate Theory of Mind concepts in the planning process of HATP/EHDA.
