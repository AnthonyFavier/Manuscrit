...
\includepdf[pages=-]{couverture_these_perso_watermark.pdf} %
%%%%%%%%%%%%%%% Uncomment this to show custom Cover page %%%%%%%%%
...
\mainmatter
\include{Chapters/Chapter0_Intro}
\include{Chapters/Chapter1_Context}

\part{Human-Aware Task Planning} \label{part:1}
\include{Chapters/Chapter2_HATPEHDA}
\include{Chapters/Chapter3_TOM}
\include{Chapters/Chapter4_Compliant}
\include{Chapters/Chapter5_Sim}
\include{Chapters/Chapter6_Study}
\include{Chapters/Task_Planning_Conclusion}

\part{Social Navigating Agents Simulation} \label{part:2}
\include{Chapters/Chapter7_InHuS}
\include{Chapters/Chapter8_IMHuS}
\include{Chapters/Nav_Conclusion}
