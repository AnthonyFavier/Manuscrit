...
% - laboratory
% - cotutelle
\title{\textbf{\large Elaboration et Apprentissage de fonctions décisionnelles pour un robot assistant ou équipier}}
\author{Anthony Favier}
\defencedate{31/03/2024}
\lab{LAAS-CNRS}
%\cotutelle{}
...
%% Jury
\njudge{7}
\makesomeone{judge}{1}{Julie Shah}{Professeure}{Rapporteur}
\makesomeone{judge}{2}{Mohamed Chetouani}{Professeur}{Rapporteur}
\makesomeone{judge}{3}{Rachid ALAMI}{Directeur de Recherche}{Directeur de Thèse}
\makesomeone{judge}{4}{Simon LACROIX}{Directeur de Recherche}{Membdre du Jury}
\makesomeone{judge}{5}{Luca Iocchi}{?}{Membre du Jury}
\makesomeone{judge}{6}{Catherine Pelachaud}{?}{Membre du Jury}
\makesomeone{judge}{7}{Jean-Charles Fabre}{?}{Membre du Jury}
